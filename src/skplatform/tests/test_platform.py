...
class SkretrievalPlatformTests(unittest.TestCase):
    ...
    def test_instrument_mounting(self):
        ...
        platform.acs.set_platform_location(latlonheight=(0, 0, 0, utc))
        ...
        # ***** THESE ALL FAIL. They need to be checked
    ...
    def test_instrument_rotation_matrix(self):
        ...
        platform.acs.rotate_instrument_in_icf(30, 60.0, 0)
        vgeo = platform.acs.convert_icf_to_gcf(vicf)
        vecef = platform.acs.convert_icf_to_ecef(vicf)
        # print('Geographic Unit vectors')
        # print(vgeo)
        ...
        self.assertAlmostEqual(vgeo[2, 1], 0., 8)
