...
class SatelliteMolniya(SatelliteBase):
    ...
    def set_molniya_from_elements(self,
        ...
        """
        Defines the Molniya orbit using Keplerian orbital ali_elements. A default, standard Molniya orbit is provided via the default
        ...
        The Molniya orbit is always kick-started using Keplerian orbital ali_elements. It can continue to use the keplerian
