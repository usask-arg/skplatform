...
..  figure:: figures/ICF_initial_orientation.png
    :scale: 100 %
    :alt: Instrument Control Frame

    ICF Initial Orientation
...
is parallel to the wings and points to the starboard side. Satellites and balloon gondolas may choose other ways to specify
...
..  figure:: figures/PCF_initial_orientation.png
    :scale: 100 %
    :alt: Platform Control Frame

    Platform Control Frame initial orientation
...
..  figure:: figures/GCF_3axes.png
    :scale: 50 %
    :alt: Geodetic Control Frame

    Geodetic Control Frame
